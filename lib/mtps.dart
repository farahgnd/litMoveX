...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  final FirebaseAuth _auth = FirebaseAuth.instance; // ← AJOUTÉ
  bool isLoading = false; // ← AJOUTÉ
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 24),
              // Bouton Envoyer le lien ← MODIFIÉ
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
                  onPressed: isLoading ? null : _sendResetEmail, // ← CHANGÉ
